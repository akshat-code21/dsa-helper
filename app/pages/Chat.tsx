...
export default function Chat({
  ...
  const pendingConversationsListRef = useRef(false);
        ...
        fetch: async (url, init) => {
          ...
          if (id) {
            ...
            if (fromHome) {
              ...
              pendingConversationsListRef.current = true;
            }
          }
          return res;
        },
  ...
  useEffect(() => {
    ...
    if (!pendingConversationsListRef.current) return;
    pendingConversationsListRef.current = false;
    ...
    <div className="flex min-h-dvh w-full min-w-0 flex-1 flex-col bg-background">
      ...
      <div className="flex min-h-0 min-w-0 flex-1">
        ...
        <SidebarInset className="min-h-0 min-w-0 flex-1 flex-col overflow-hidden">
          <div className="flex shrink-0 items-center bg-background px-1 md:px-1.5">
